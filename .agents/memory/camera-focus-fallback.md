...
**How to apply:** Feature-detect and catch focus-constraint failures, then use a short focus-settling gate before manual or automatic capture. Camera startup must be session-safe so late permission results cannot revive a stopped stream.