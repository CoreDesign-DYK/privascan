...
export const getSendByEmailUrl = () => {




  return `/api/share/email`
}

/**
 * @summary Send a scan by email
 */
export const sendByEmail = async (emailShareInput: EmailShareInput, options?: Parameters<typeof customFetch>[1]): Promise<EmailShareResult> => {

  return customFetch<EmailShareResult>(getSendByEmailUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(emailShareInput)
  }
);}
...
export const getSendByEmailMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof sendByEmail>>, TError,{data: BodyType<EmailShareInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof sendByEmail>>, TError,{data: BodyType<EmailShareInput>}, TContext> => {

const mutationKey = ['sendByEmail'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof sendByEmail>>, {data: BodyType<EmailShareInput>}> = (props) => {
          const {data} = props ?? {};

          return  sendByEmail(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SendByEmailMutationResult = NonNullable<Awaited<ReturnType<typeof sendByEmail>>>
    export type SendByEmailMutationBody = BodyType<EmailShareInput>
    export type SendByEmailMutationError = ErrorType<void>

    /**
 * @summary Send a scan by email
 */
export const useSendByEmail = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof sendByEmail>>, TError,{data: BodyType<EmailShareInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof sendByEmail>>,
        TError,
        {data: BodyType<EmailShareInput>},
        TContext
      > => {
      return useMutation(getSendByEmailMutationOptions(options));
    }
