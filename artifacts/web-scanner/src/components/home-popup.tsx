...
const SIGN_IN_METHODS: { id: Provider; label: string; bg: string; iconEl: React.ReactNode }[] = [
  {
    ...
    bg: 'bg-[#4285F4] hover:bg-[#3b78e7]',
    iconEl: <svg viewBox="0 0 48 48" className="w-5 h-5 shrink-0"><path fill="#fff" d="M44.5 20H24v8.5h11.8C34.7 33.9 30.1 37 24 37c-7.2 0-13-5.8-13-13s5.8-13 13-13c3.1 0 5.9 1.1 8.1 2.9l6-6C34.6 5.1 29.6 3 24 3 12.4 3 3 12.4 3 24s9.4 21 21 21c10.5 0 20-7.6 20-21 0-1.4-.2-2.7-.5-4z"/></svg>,
  },
  {
              ...
              <div className="flex items-center gap-2.5 mt-3">
                {SIGN_IN_METHODS.map(m => (
                  <button key={m.id} onClick={goSignIn} className={cn(
                    ...
                    m.id === 'google' ? 'bg-white border border-gray-200' :
                    m.id === 'apple'  ? 'bg-black' :
